...
//midGods.forEach((god, index) => {
//  console.log(`${index}: ${JSON.stringify (god)}`)})

//Q3
//const sortedGods = gods.sort((object, objectCompared) => object.pantheon.localeCompare(objectCompared.pantheon));
//sortedGods.forEach(god => console.log(god))

//Q4
// const newGods = gods.map(god => `${god.name} (${god.class})`)
// newGods.forEach(god => console.log(god))